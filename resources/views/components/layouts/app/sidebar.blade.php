    ...
    <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            ...
            @if(auth()->user()->role === 'user')
                ...
                <!-- 🆕 Review Section -->
                <flux:navlist.group heading="{{ __('Review') }}" expandable>
                    <flux:navlist.item 
                        icon="star" 
                        :href="route('reviews.my')" 
                        :current="request()->routeIs('reviews.my')" 
                        wire:navigate>
                        {{ __('My Reviews') }}
                    </flux:navlist.item>
                    <flux:navlist.item 
                        icon="eye" 
                        :href="route('reviews.view')" 
                        :current="request()->routeIs('reviews.view')" 
                        wire:navigate>
                        {{ __('View Reviews') }}
                    </flux:navlist.item>
                </flux:navlist.group>
